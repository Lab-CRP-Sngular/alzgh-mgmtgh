...
CAMBIADO PARA QUE TODAS ESTEN EN MANAGEMENT
*/
...
*/
subscription_ids = {
  management  = "951b0c89-351b-4e98-8bf0-b405f01e602c"
}  
custom_replacements = {
  /*
  ...
  */
  names = {
    ...
    defender_email_security_contact = "pacogomezleo@gmail.com"
  ...
  */
  resource_group_identifiers = {
    ...
    ddos_protection_plan_resource_group_id = "/subscriptions/$${subscription_id_management}/resourcegroups/$${ddos_resource_group_name}"
    primary_connectivity_resource_group_id = "/subscriptions/$${subscription_id_management}/resourceGroups/$${connectivity_hub_primary_resource_group_name}"
    dns_resource_group_id                  = "/subscriptions/$${subscription_id_management}/resourceGroups/$${dns_resource_group_name}"
  }
...
management_group_settings = {
  ...
  policy_default_values = {
    ...
    private_dns_zone_subscription_id            = "$${subscription_id_management}"
